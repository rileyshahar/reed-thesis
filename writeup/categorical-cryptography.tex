...
\subsection{General Process Conversions}
...
list. Composition of general combs is as with 1-combs: given an n-comb and n combs
 such that the types line up, we nest each of the combs into the outer n-comb.
