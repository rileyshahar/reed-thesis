...
\begin{ex}[Factoring {\cite[Section 2.3]{pass-shelat-2020}}]
...
\begin{ex}[Discrete Logarithm {\cite[Section 8.3.2]{katz-lindell-2014}}]
...
\begin{ex}[a straightforward proof by reduction {\cite[Section
...
\section{Interactive Computation}
