...
\Cref{eqn:monoid associative} asserts commutativity of the
diagram \[
  \begin{tikzcd}
...
What coherence axioms should this satisfy? It should certainly be coherent with
the identity:
...
% While monoidal categories enhance categorical structure with a notion of
% parallel composition, there is another, possibly simpler, axiomatization
% possible.
