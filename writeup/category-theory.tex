...
The following construction is very important.

\begin{dfn}
  Given two categories $\cat{C}$ and $\cat{D}$, the \emph{product category}
  $\cat{C}\times\cat{D}$ has:
  \begin{itemize}
...
\begin{ex}
  ...
  \begin{itemize}
    ...
    \item When $\cat{C}$ and $\cat{D}$ are monoidal, $\cat{C}\times\cat{D}$ is
      monoidal with the componentwise product, i.e. $(x, y)\otimes(x', y') =
      (x\otimes_\cat{C} x', y\otimes_\cat{D} y')$.
  \end{itemize}
\end{ex}
